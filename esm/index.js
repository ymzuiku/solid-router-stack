...
`};import{createEffect as wt,createSignal as St}from"solid-js";function Kt(t,n,r){let[i,u]=St(t[n]||r);return wt(()=>{u(t[n]||r)}),[i,u]}var j=(t,n=260)=>{if(Object.assign(p,{navigationDuration:n}),typeof window<"u"){let r=document.getElementById("solid-router-stack-css");if(r)r.innerHTML=t;else{let i=document.createElement("style");i.id="solid-router-stack-css",i.innerHTML=t,document.head.append(i)}}},yt={moveTop:R,moveLeft:D,scale:tt},Mt=(t,n=150)=>{if(t==="none"){p.navigationDuration=0;let r=document.getElementById("solid-router-stack-css");r&&r.remove()}else t==="auto"?typeof window>"u"?j(R(n),n+10):j(window.innerWidth>window.innerHeight?R(n):D(n+10),260):j(yt[t](n),n+10)};var At=xt("<div></div>",2);var g="solid-router-stack-now",O="solid-router-stack-before",Ht="solid-router-stack-leave",P="solid-router-stack-after",c={ignoreAnime:!1,isVirtualHistory:!1,lastLen:0},ne=t=>{let n={...t},[r,i]=_t(()=>$([])),u=s=>{let[e,o]=$(s.path),[l,E]=$(""),[S,y]=$(!0),[T,B]=$(!1),[N,d]=$(s.params);return{path:e,setPath:o,css:l,setCss:E,stackTop:S,setStackTop:y,params:N,setParams:d,stackShow:T,setStackShow:B}},k=()=>{let s=r(),e=s[s.length-1];e&&e.setStackTop(!1);let o=a.stack[a.stack.length-1],l,E=s.length,S=0;for(let y=0;y<E;y++){let T=s[y-S];T.path()===o.path&&(l=T,s.splice(y-S,1),S++)}l?l.setParams(o.params):l=u(o),l.setStackTop(!0),l.setStackShow(!0),i([...s,l])},_=()=>{let s=r(),e=s[s.length-1];e&&e.setStackTop(!1);let o=a.stack[a.stack.length-1],l=u(o);i([...r(),l])},A=()=>{let s=a.stack[a.stack.length-1],e=r();if(e.length>1){let o=e[e.length-2];o.setStackTop(!0),o.setPath(s.path),o.setParams(s.params),i([...e])}setTimeout(()=>{e.pop(),i([...e])},p.navigationDuration)},et=()=>{let s=r();s.pop();let e=a.stack[a.stack.length-1],o=u(e);o.setStackShow(!0),i([...s,o])},st=()=>{i([]),_()},f=s=>{if(p.navigationDuration==0)return;let e=r(),o=e[e.length-1];o&&o.setCss(s)},b=s=>{if(p.navigationDuration==0)return;let e=r(),o=e[e.length-2];o&&o.setCss(s)},v=s=>{let e=r(),o=e[e.length-1];o&&o.setStackShow(s)},w=s=>{let e=r(),o=e[e.length-2];o&&o.setStackShow(s)};a.listen((s,e)=>{let o=a.stack.length;e==="pushSingleState"?(k(),c.ignoreAnime?(v(!0),w(!1),f(g),b(P)):(v(!0),setTimeout(()=>{w(!1)},p.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(g)}))):e==="clearState"?(st(),c.ignoreAnime?(v(!0),w(!1),f(g),b(P)):(v(!0),setTimeout(()=>{w(!1)},p.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(g)}))):o>c.lastLen?(_(),c.ignoreAnime?(v(!0),w(!1),f(g),b(P)):(v(!0),setTimeout(()=>{w(!1)},p.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(g)}))):c.lastLen!==o&&o>=1?(v(!0),w(!0),f(Ht),b(g),A(),c.ignoreAnime?f(g):setTimeout(()=>{f(g)},p.navigationDuration)):(v(!0),w(!0),et(),f(g)),c.lastLen=o,c.ignoreAnime&&requestAnimationFrame(()=>{c.ignoreAnime=!1})});let nt=(s,e)=>{e&&(c.ignoreAnime=!0),a.goBack(s,c.isVirtualHistory)},K=s=>{if(s.sync)s.Component=s.render;else{let e=Lt(s.render);s.Component=o=>F(e,o)}s.push=(e,o)=>{o&&(c.ignoreAnime=!0),a.push(a.parasmUrl(s.path,e),c.isVirtualHistory)},s.pushSingle=(e,o)=>{o&&(c.ignoreAnime=!0),a.pushSingle(a.parasmUrl(s.path,e))},s.replace=(e,o)=>{o&&(c.ignoreAnime=!0),a.replace(a.parasmUrl(s.path,e))},s.clearTo=(e,o)=>{o&&(c.ignoreAnime=!0),a.clearTo(a.parasmUrl(s.path,e))}};K(p.notFound),Object.keys(n).forEach(s=>{let e=n[s];K(e)});let U={},W=[];Object.keys(n).map(s=>{let e=n[s];e&&(U[e.path]=e,e.sync||W.push(e))});function ot(s){s.preloadAll?W.forEach(e=>{e.render().then(o=>{e.Component=o.default,e.sync=!0})}):s.preload&&s.preload.length&&setTimeout(()=>{s.preload.forEach(e=>{let o=n[e];o&&!o.sync&&o.render().then(l=>{o.Component=l.default,o.sync=!0})})},200)}return{...n,goBack:nt,Routers:({root:s,hash:e,ignoreFull:o,virtualHistory:l})=>{a.useHash=!!e,c.isVirtualHistory=!!l;let E=a.nowUrl(),S=a.searchUrlToObject(a.nowFullUrl());c.ignoreAnime=!0,E!=="/"&&E!==s.path?(s.push(void 0,!0),(U[E]||p.notFound).push({...S})):s.push(S,!0);let[y,T]=$(typeof window<"u"?window.innerWidth:0),[B,N]=$(typeof window<"u"?window.innerHeight:0);return o||typeof window<"u"&&window.addEventListener("resize",()=>{T(window.innerWidth),N(window.innerHeight)}),F(Ct,{get each(){return r()},children:(d,at)=>{let q=U[d.path()]||p.notFound;ot(q);let rt=q.Component;return(()=>{let m=At.cloneNode(!0);return m.style.setProperty("position","fixed"),m.style.setProperty("top","0px"),m.style.setProperty("left","0px"),Tt(m,F(rt,Pt({get stackLength(){return r().length},get stackTop(){return d.stackTop()},get stackShow(){return d.stackShow()}},()=>d.params()))),Et(h=>{let z=d.path(),it={[d.css()]:!0,[p.className]:!0},M=d.stackTop()?"auto":"none",I=at()*10,V=o?void 0:y()+"px",X=o?void 0:B()+"px";return z!==h._v$&&bt(m,"data-path",h._v$=z),h._v$2=$t(m,it,h._v$2),M!==h._v$3&&m.style.setProperty("pointer-events",h._v$3=M),I!==h._v$4&&m.style.setProperty("z-index",h._v$4=I),V!==h._v$5&&m.style.setProperty("width",h._v$5=V),X!==h._v$6&&m.style.setProperty("height",h._v$6=X),h},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),m})()}})}}};export{Kt as createPropsSignal,ne as createRouters,a as historyProxy,D as moveLeftCss,R as moveTopCss,tt as scaleCss,j as setCustomNavigationAnimation,Mt as setNavigationAnimation,p as stackOptions};
