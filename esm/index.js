...
`};import{createEffect as yt,createSignal as xt}from"solid-js";function qt(t,n,r){let[i,p]=xt(t[n]||r);return yt(()=>{p(t[n]||r)}),[i,p]}var j=(t,n=260)=>{if(Object.assign(l,{navigationDuration:n}),typeof window<"u"){let r=document.getElementById("solid-router-stack-css");if(r)r.innerHTML=t;else{let i=document.createElement("style");i.id="solid-router-stack-css",i.innerHTML=t,document.head.append(i)}}},$t={moveTop:A,moveLeft:D,scale:st},Xt=(t,n=150)=>{if(t==="none"){l.navigationDuration=0;let r=document.getElementById("solid-router-stack-css");r&&r.remove()}else t==="auto"?typeof window>"u"?j(A(n),n+10):j(window.innerWidth>window.innerHeight?A(n):D(n+10),260):j($t[t](n),n+10)};var Lt=bt("<div></div>",2);var k="solid-router-stack-now",O="solid-router-stack-before",Ht="solid-router-stack-leave",P="solid-router-stack-after",h=!1,K=!1,W=0,ae=t=>{let n={...t},[r,i]=Rt(()=>$([])),p=s=>{let[e,o]=$(s.path),[c,E]=$(""),[S,y]=$(!0),[T,B]=$(!1),[N,d]=$(s.params);return{path:e,setPath:o,css:c,setCss:E,stackTop:S,setStackTop:y,params:N,setParams:d,stackShow:T,setStackShow:B}},g=()=>{let s=r(),e=s[s.length-1];e&&e.setStackTop(!1);let o=a.stack[a.stack.length-1],c,E=s.length,S=0;for(let y=0;y<E;y++){let T=s[y-S];T.path()===o.path&&(c=T,s.splice(y-S,1),S++)}c?c.setParams(o.params):c=p(o),c.setStackTop(!0),c.setStackShow(!0),i([...s,c])},C=()=>{let s=r(),e=s[s.length-1];e&&e.setStackTop(!1);let o=a.stack[a.stack.length-1],c=p(o);i([...r(),c])},_=()=>{let s=a.stack[a.stack.length-1],e=r();if(e.length>1){let o=e[e.length-2];o.setStackTop(!0),o.setPath(s.path),o.setParams(s.params),i([...e])}setTimeout(()=>{e.pop(),i([...e])},l.navigationDuration)},nt=()=>{let s=r();s.pop();let e=a.stack[a.stack.length-1],o=p(e);o.setStackShow(!0),i([...s,o])},ot=()=>{i([]),C()},f=s=>{if(l.navigationDuration==0)return;let e=r(),o=e[e.length-1];o&&o.setCss(s)},b=s=>{if(l.navigationDuration==0)return;let e=r(),o=e[e.length-2];o&&o.setCss(s)},v=s=>{let e=r(),o=e[e.length-1];o&&o.setStackShow(s)},w=s=>{let e=r(),o=e[e.length-2];o&&o.setStackShow(s)};a.listen((s,e)=>{let o=a.stack.length;e==="pushSingleState"?(g(),h?(v(!0),w(!1),f(k),b(P)):(v(!0),setTimeout(()=>{w(!1)},l.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(k)}))):e==="clearState"?(ot(),h?(v(!0),w(!1),f(k),b(P)):(v(!0),setTimeout(()=>{w(!1)},l.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(k)}))):o>W?(C(),h?(v(!0),w(!1),f(k),b(P)):(v(!0),setTimeout(()=>{w(!1)},l.navigationDuration),f(O),requestAnimationFrame(()=>{b(P),f(k)}))):W!==o&&o>=1?(v(!0),w(!0),f(Ht),b(k),_(),h?f(k):setTimeout(()=>{f(k)},l.navigationDuration)):(v(!0),w(!0),nt(),f(k)),W=o,h&&requestAnimationFrame(()=>{h=!1})});let at=(s,e)=>{e&&(h=!0),a.goBack(s,K)},q=s=>{if(s.sync)s.Component=s.render;else{let e=At(s.render);s.Component=o=>F(e,o)}s.push=(e,o)=>{o&&(h=!0),a.push(a.parasmUrl(s.path,e),K)},s.pushSingle=(e,o)=>{o&&(h=!0),a.pushSingle(a.parasmUrl(s.path,e))},s.replace=(e,o)=>{o&&(h=!0),a.replace(a.parasmUrl(s.path,e))},s.clearTo=(e,o)=>{o&&(h=!0),a.clearTo(a.parasmUrl(s.path,e))}};q(l.notFound),Object.keys(n).forEach(s=>{let e=n[s];q(e)});let H={},z=[];Object.keys(n).map(s=>{let e=n[s];e&&(H[e.path]=e,e.sync||z.push(e))});function rt(s){s.preloadAll?z.forEach(e=>{e.render().then(o=>{e.Component=o.default,e.sync=!0})}):s.preload&&s.preload.length&&setTimeout(()=>{s.preload.forEach(e=>{let o=n[e];o&&!o.sync&&o.render().then(c=>{o.Component=c.default,o.sync=!0})})},200)}return{...n,goBack:at,Routers:({root:s,hash:e,ignoreFull:o,virtualHistory:c})=>{a.useHash=!!e,K=!!c;let E=a.nowUrl(),S=a.searchUrlToObject(a.nowFullUrl());h=!0,E!=="/"&&E!==s.path?(s.push(void 0,!0),(H[E]||l.notFound).push({...S})):s.push(S,!0);let[y,T]=$(typeof window<"u"?window.innerWidth:0),[B,N]=$(typeof window<"u"?window.innerHeight:0);return o||typeof window<"u"&&window.addEventListener("resize",()=>{T(window.innerWidth),N(window.innerHeight)}),F(Ut,{get each(){return r()},children:(d,it)=>{let M=H[d.path()]||l.notFound;rt(M);let ct=M.Component;return(()=>{let m=Lt.cloneNode(!0);return m.style.setProperty("position","fixed"),m.style.setProperty("top","0px"),m.style.setProperty("left","0px"),_t(m,F(ct,Ct({get stackLength(){return r().length},get stackTop(){return d.stackTop()},get stackShow(){return d.stackShow()}},()=>d.params()))),Pt(u=>{let I=d.path(),lt={[d.css()]:!0,[l.className]:!0},X=d.stackTop()?"auto":"none",Y=it()*10,G=o?void 0:y()+"px",J=o?void 0:B()+"px";return I!==u._v$&&Tt(m,"data-path",u._v$=I),u._v$2=Et(m,lt,u._v$2),X!==u._v$3&&m.style.setProperty("pointer-events",u._v$3=X),Y!==u._v$4&&m.style.setProperty("z-index",u._v$4=Y),G!==u._v$5&&m.style.setProperty("width",u._v$5=G),J!==u._v$6&&m.style.setProperty("height",u._v$6=J),u},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),m})()}})}}};export{qt as createPropsSignal,ae as createRouters,a as historyProxy,D as moveLeftCss,A as moveTopCss,st as scaleCss,j as setCustomNavigationAnimation,Xt as setNavigationAnimation,l as stackOptions};
