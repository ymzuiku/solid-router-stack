import{template as wt}from"solid-js/web";import{mergeProps as J}from"solid-js/web";import{className as yt}from"solid-js/web";import{setAttribute as bt}from"solid-js/web";import{effect as $t}from"solid-js/web";import{memo as St}from"solid-js/web";import{insert as K}from"solid-js/web";import{createComponent as $}from"solid-js/web";import{createRoot as xt,createSignal as V,For as Et,lazy as Tt,Suspense as _t}from"solid-js";import{createStore as Ut}from"solid-js/store";var I=[],ct=t=>{I.push(t)},w=[],lt=t=>{w.push(t)},T="";["popstate","pushState","replaceState","backState"].forEach(t=>{window.addEventListener(t,()=>{let e=z();if(console.log("__debug__","inin",e,T),t==="popstate")if(e===T){let o=X();s.stack[s.stack.length-1]=m(o)}else s.stack.pop();let n=s.stack[s.stack.length-1];I.forEach(o=>{o(n?n.path:"",t,s.stack)}),T=e})});var m=t=>({url:t,path:t.split("?")[0],params:_(t)||{},time:Date.now(),index:s.stack.length}),pt=t=>{w.forEach(e=>{t=e(t)}),s.stack.push(m(t)),s.useHash&&(t="/#"+t),history.pushState(null,"",t),window.dispatchEvent(new Event("pushState"))},ft=t=>{w.forEach(e=>{t=e(t)}),s.stack.push(m(t)),s.useHash&&(t="/#"+t),history.replaceState(null,"",t),window.dispatchEvent(new Event("replaceState"))},D=t=>{w.forEach(e=>{t=e(t)}),s.stack.length>0&&s.stack.pop(),s.stack.push(m(t)),s.useHash&&(t="/#"+t),history.replaceState(null,"",t),window.dispatchEvent(new Event("replaceState"))},M=t=>{if(s.stack.length==1)return"";s.stack.pop();let n=s.stack[s.stack.length-1],o=n.path;return s.useHash&&(o="/#"+n.path),o=Y(o,{..._(n.url),...t}),n.url=o,o},ut=t=>{let e=M(t);e!=""&&(history.replaceState(null,"",e),window.dispatchEvent(new Event("backState")))},ht=t=>{let e=M(t);e!=""&&(history.replaceState(null,"",e),window.dispatchEvent(new Event("replaceState")))},dt=t=>{s.stack=[m(t)],D(t)};function mt(){let[t,e]=location.href.split("#");return new URLSearchParams([t.split("?")[1],e.split("?")[1]].join("&"))}function z(){if(!location.hash)return"/";let t=location.hash.split("#");return t.length<2?"/":t[1].split("?")[0]}function X(){if(!location.hash)return"/";let t=location.hash.split("#");return t.length<2?"/":t[1]}function Y(t,e){if(e){let n={};Object.keys(e).forEach(c=>{let f=e[c];f!==void 0&&f!==""&&(n[c]=f)});let o=new URLSearchParams(n).toString();return o?t+"?"+o:t}return t}function _(t){let[e,n]=t.split("#"),o=new URLSearchParams([e.split("?")[1],n?n.split("?")[1]:""].join("&")),c={},f=!1;for(let[k,p]of o.entries())f=!0,p!==void 0&&p!==""&&(c[k]=p);if(!!f)return c}var s={search:mt,nowUrl:z,nowFullUrl:X,push:pt,pushNotHistory:ft,replace:D,goBack:ut,gobackNotHistory:ht,clearTo:dt,listen:ct,beforeChange:lt,searchUrlToObject:_,parasmUrl:Y,onLastBack:t=>t.url,newStack:m,stack:[],useHash:!1};var y;function U(){if(y!==void 0)return y;let t=navigator.userAgent.toLocaleLowerCase();return y=new RegExp("(iphone|ipod|ipad)").test(t)&&new RegExp("(micromessenger)").test(t),y}import{template as q}from"solid-js/web";var gt=q("<div>Not found page</div>",2),kt=q("<div></div>",2),u={navigationDuration:0,notFound:{async:!0,render:()=>gt.cloneNode(!0)},fallback:kt.cloneNode(!0)};var b=t=>{let e=`transition: transform ${t}ms ease-out, opacity ${t}ms ease-out;`;return`
...
`},G=t=>{let e=`transition: transform ${t}ms ease-out, opacity ${t}ms ease-out;`;return`
.solid-router-stack-now {
  ${e}
}
.solid-router-stack-before {
