...
`};var E=(t,e=260)=>{if(Object.assign(h,{navigationDuration:e}),typeof window<"u"){let n=document.getElementById("solid-router-stack-css");if(n)n.innerHTML=t;else{let o=document.createElement("style");o.id="solid-router-stack-css",o.innerHTML=t,document.head.append(o)}}},Pt={moveTop:w,moveLeft:x,scale:N},Rt=(t,e=250)=>{if(t==="none"){h.navigationDuration=0;let n=document.getElementById("solid-router-stack-css");n&&n.remove()}else t==="auto"?typeof window>"u"?E(w(e),e+10):E(window.innerWidth>window.innerHeight?w(e):x(e+10),260):E(Pt[t](e),e+10)};var Z=(0,et.template)("<div></div>",2),k="solid-router-stack-now",Ht="solid-router-stack-before",Nt="solid-router-stack-leave",tt="solid-router-stack-after",Ot=t=>{let e={...t},[n,o]=(0,f.createRoot)(()=>(0,at.createStore)({list:s.stack})),i=r=>{o("list",n.list.length-1,{className:r})},u=r=>{n.list.length>1&&o("list",n.list.length-2,{className:r})},v=0,p=!1;s.listen(()=>{let r=s.stack.length,a=s.stack[s.stack.length-1];h.navigationDuration>0?r>v?(o("list",[...s.stack]),o("list",n.list.length-1,{stackTop:!0}),n.list.length>1&&o("list",n.list.length-2,{stackTop:!1}),p?(i(k),u(tt)):(i(Ht),requestAnimationFrame(()=>{i(k),u(tt)}))):v!==r&&r>=1?(o("list",n.list.length-2,{stackTop:!0}),n.list.length>2&&o("list",n.list.length-3,{stackTop:!1}),i(Nt),u(k),p?(o("list",[...s.stack]),o("list",n.list.length-1,{stackTop:!0})):setTimeout(()=>{o("list",[...s.stack]),i(k),o("list",n.list.length-1,{stackTop:!0})},h.navigationDuration)):(o("list",[...s.stack]),o("list",n.list.length-1,{stackTop:!0}),n.list.length>1&&o("list",n.list.length-2,{stackTop:!1}),i(k)):(o("list",[...s.stack]),o("list",n.list.length-1,{stackTop:!0}),n.list.length>1&&o("list",n.list.length-2,{stackTop:!1}),i(k)),v=r,o("list",s.stack.length-1,{params:a?{...s.searchUrlToObject(a.url)}:{}}),p&&requestAnimationFrame(()=>{p=!1})});let it=r=>{R()?s.gobackNotHistory(r):s.goBack(r)},A=r=>{r.async?r.Component=r.render:r.Component=(0,f.lazy)(r.render),r.push=a=>{R()?s.pushNotHistory(s.parasmUrl(r.path,a)):s.push(s.parasmUrl(r.path,a))},r.replace=a=>{s.replace(s.parasmUrl(r.path,a))},r.clearTo=a=>{p=!0,s.clearTo(s.parasmUrl(r.path,a))}};A(h.notFound),Object.keys(e).forEach(r=>{let a=e[r];A(a)});let T={},B=[];Object.keys(e).map(r=>{let a=e[r];a&&(T[a.path]=a,a.async||B.push(a))});function ct(r){r.preloadAll?B.forEach(a=>{a.render()}):r.preload&&r.preload.length&&setTimeout(()=>{r.preload.forEach(a=>{let m=e[a];m&&!m.async&&m.render()})},200)}let lt=({root:r,hash:a,ignoreFull:m})=>{s.useHash=!!a;let _=s.nowUrl(),F=s.searchUrlToObject(s.nowFullUrl());if(p=!0,_!=="/"&&_!==r.path){r.push();let b=T[_]||h.notFound;p=!0,b.push({...F})}else r.push(F);let[pt,ft]=(0,f.createSignal)(typeof window<"u"?window.innerWidth:0),[ut,ht]=(0,f.createSignal)(typeof window<"u"?window.innerHeight:0);return m||typeof window<"u"&&window.addEventListener("resize",()=>{ft(window.innerWidth),ht(window.innerHeight)}),(()=>{let b=Z.cloneNode(!0);return(0,j.insert)(b,(0,y.createComponent)(f.For,{get each(){return n.list},children:(d,dt)=>{let U=T[d.path]||h.notFound;ct(U);let W=U.Component;return(()=>{let l=Z.cloneNode(!0);return l.style.setProperty("position","fixed"),l.style.setProperty("top","0px"),l.style.setProperty("left","0px"),l.style.setProperty("background","#fff"),(0,j.insert)(l,(()=>{let c=(0,rt.memo)(()=>!!U.async,!0);return()=>c()?(0,y.createComponent)(W,(0,O.mergeProps)({get stackTop(){return d.stackTop}},()=>d.params)):(0,y.createComponent)(f.Suspense,{get fallback(){return h.fallback},get children(){return(0,y.createComponent)(W,(0,O.mergeProps)({get stackTop(){return d.stackTop}},()=>d.params))}})})()),(0,ot.effect)(c=>{let z=d.path,I=d.className,D=d.stackTop?"auto":"none",M=dt()*10,X=m?void 0:pt()+"px",Y=m?void 0:ut()+"px";return z!==c._v$&&(0,nt.setAttribute)(l,"data-path",c._v$=z),I!==c._v$2&&(0,st.className)(l,c._v$2=I),D!==c._v$3&&l.style.setProperty("pointer-events",c._v$3=D),M!==c._v$4&&l.style.setProperty("z-index",c._v$4=M),X!==c._v$5&&l.style.setProperty("width",c._v$5=X),Y!==c._v$6&&l.style.setProperty("height",c._v$6=Y),c},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),l})()}})),b})()};return{...e,goBack:it,history:{search:s.search,nowUrl:s.nowUrl,nowFullUrl:s.nowFullUrl,searchUrlToObject:s.searchUrlToObject,listen:s.listen,beforeChange:s.beforeChange,getStack:()=>s.stack},Routers:lt}};
