...
`};var B=require("solid-js");function Bt(t,e,r){let[i,c]=(0,B.createSignal)(t[e]||r);return(0,B.createEffect)(()=>{c(t[e]||r)}),[i,c]}var N=(t,e=260)=>{if(Object.assign(l,{navigationDuration:e}),typeof window<"u"){let r=document.getElementById("solid-router-stack-css");if(r)r.innerHTML=t;else{let i=document.createElement("style");i.id="solid-router-stack-css",i.innerHTML=t,document.head.append(i)}}},Nt={moveTop:C,moveLeft:H,scale:q},Dt=(t,e=150)=>{if(t==="none"){l.navigationDuration=0;let r=document.getElementById("solid-router-stack-css");r&&r.remove()}else t==="auto"?typeof window>"u"?N(C(e),e+10):N(window.innerWidth>window.innerHeight?C(e):H(e+10),260):N(Nt[t](e),e+10)};var jt=(0,at.template)("<div></div>",2);var g="solid-router-stack-now",z="solid-router-stack-before",Ft="solid-router-stack-leave",P="solid-router-stack-after",m=!1,M=!1,I=0,Ot=t=>{let e={...t},[r,i]=(0,f.createRoot)(()=>(0,f.createSignal)([])),c=n=>{let[s,a]=(0,f.createSignal)(n.path),[p,E]=(0,f.createSignal)(""),[y,x]=(0,f.createSignal)(!0),[T,F]=(0,f.createSignal)(!1),[O,k]=(0,f.createSignal)(n.params);return{path:s,setPath:a,css:p,setCss:E,stackTop:y,setStackTop:x,params:O,setParams:k,stackShow:T,setStackShow:F}},v=()=>{let n=r(),s=n[n.length-1];s&&s.setStackTop(!1);let a=o.stack[o.stack.length-1],p,E=n.length,y=0;for(let x=0;x<E;x++){let T=n[x-y];T.path()===a.path&&(p=T,n.splice(x-y,1),y++)}p?p.setParams(a.params):p=c(a),p.setStackTop(!0),p.setStackShow(!0),i([...n,p])},L=()=>{let n=r(),s=n[n.length-1];s&&s.setStackTop(!1);let a=o.stack[o.stack.length-1],p=c(a);i([...r(),p])},_=()=>{let n=o.stack[o.stack.length-1],s=r();if(s.length>1){let a=s[s.length-2];a.setStackTop(!0),a.setPath(n.path),a.setParams(n.params),i([...s])}setTimeout(()=>{s.pop(),i([...s])},l.navigationDuration)},ft=()=>{let n=r();n.pop();let s=o.stack[o.stack.length-1],a=c(s);a.setStackShow(!0),i([...n,a])},ut=()=>{i([]),L()},u=n=>{if(l.navigationDuration==0)return;let s=r(),a=s[s.length-1];a&&a.setCss(n)},b=n=>{if(l.navigationDuration==0)return;let s=r(),a=s[s.length-2];a&&a.setCss(n)},w=n=>{let s=r(),a=s[s.length-1];a&&a.setStackShow(n)},S=n=>{let s=r(),a=s[s.length-2];a&&a.setStackShow(n)};o.listen((n,s)=>{let a=o.stack.length;s==="pushSingleState"?(v(),m?(w(!0),S(!1),u(g),b(P)):(w(!0),setTimeout(()=>{S(!1)},l.navigationDuration),u(z),requestAnimationFrame(()=>{b(P),u(g)}))):s==="clearState"?(ut(),m?(w(!0),S(!1),u(g),b(P)):(w(!0),setTimeout(()=>{S(!1)},l.navigationDuration),u(z),requestAnimationFrame(()=>{b(P),u(g)}))):a>I?(L(),m?(w(!0),S(!1),u(g),b(P)):(w(!0),setTimeout(()=>{S(!1)},l.navigationDuration),u(z),requestAnimationFrame(()=>{b(P),u(g)}))):I!==a&&a>=1?(w(!0),S(!0),u(Ft),b(g),_(),m?u(g):setTimeout(()=>{u(g)},l.navigationDuration)):(w(!0),S(!0),ft(),u(g)),I=a,m&&requestAnimationFrame(()=>{m=!1})});let ht=(n,s)=>{s&&(m=!0),o.goBack(n,M)},X=n=>{if(n.sync)n.Component=n.render;else{let s=(0,f.lazy)(n.render);n.Component=a=>(0,D.createComponent)(s,a)}n.push=(s,a)=>{a&&(m=!0),o.push(o.parasmUrl(n.path,s),M)},n.pushSingle=(s,a)=>{a&&(m=!0),o.pushSingle(o.parasmUrl(n.path,s))},n.replace=(s,a)=>{a&&(m=!0),o.replace(o.parasmUrl(n.path,s))},n.clearTo=(s,a)=>{a&&(m=!0),o.clearTo(o.parasmUrl(n.path,s))}};X(l.notFound),Object.keys(e).forEach(n=>{let s=e[n];X(s)});let j={},Y=[];Object.keys(e).map(n=>{let s=e[n];s&&(j[s.path]=s,s.sync||Y.push(s))});function mt(n){n.preloadAll?Y.forEach(s=>{s.render().then(a=>{s.Component=a.default,s.sync=!0})}):n.preload&&n.preload.length&&setTimeout(()=>{n.preload.forEach(s=>{let a=e[s];a&&!a.sync&&a.render().then(p=>{a.Component=p.default,a.sync=!0})})},200)}return{...e,goBack:ht,Routers:({root:n,hash:s,ignoreFull:a,virtualHistory:p})=>{o.useHash=!!s,M=!!p;let E=o.nowUrl(),y=o.searchUrlToObject(o.nowFullUrl());m=!0,E!=="/"&&E!==n.path?(n.push(void 0,!0),(j[E]||l.notFound).push({...y})):n.push(y,!0);let[x,T]=(0,f.createSignal)(typeof window<"u"?window.innerWidth:0),[F,O]=(0,f.createSignal)(typeof window<"u"?window.innerHeight:0);return a||typeof window<"u"&&window.addEventListener("resize",()=>{T(window.innerWidth),O(window.innerHeight)}),(0,D.createComponent)(f.For,{get each(){return r()},children:(k,dt)=>{let G=j[k.path()]||l.notFound;mt(G);let kt=G.Component;return(()=>{let d=jt.cloneNode(!0);return d.style.setProperty("position","fixed"),d.style.setProperty("top","0px"),d.style.setProperty("left","0px"),(0,lt.insert)(d,(0,D.createComponent)(kt,(0,pt.mergeProps)({get stackLength(){return r().length},get stackTop(){return k.stackTop()},get stackShow(){return k.stackShow()}},()=>k.params()))),(0,ct.effect)(h=>{let J=k.path(),gt={[k.css()]:!0,[l.className]:!0},Q=k.stackTop()?"auto":"none",V=dt()*10,Z=a?void 0:x()+"px",tt=a?void 0:F()+"px";return J!==h._v$&&(0,it.setAttribute)(d,"data-path",h._v$=J),h._v$2=(0,rt.classList)(d,gt,h._v$2),Q!==h._v$3&&d.style.setProperty("pointer-events",h._v$3=Q),V!==h._v$4&&d.style.setProperty("z-index",h._v$4=V),Z!==h._v$5&&d.style.setProperty("width",h._v$5=Z),tt!==h._v$6&&d.style.setProperty("height",h._v$6=tt),h},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),d})()}})}}};
